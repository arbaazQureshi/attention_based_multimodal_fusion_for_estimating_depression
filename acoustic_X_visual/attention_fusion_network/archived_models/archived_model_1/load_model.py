...
def load_model(location=None):
	...
	COVAREP_X_FORMANT_shortened = Dense(400, activation = 'relu')(COVAREP_X_FORMANT)

	facial_X_pose_shortened = Dense(900, activation = 'relu')(facial_X_pose)
	facial_X_pose_shortened = Dense(400, activation = 'relu')(facial_X_pose_shortened)

	gaze_X_action_shortened = Dense(600, activation = 'relu')(gaze_X_action)
	gaze_X_action_shortened = Dense(400, activation = 'relu')(gaze_X_action_shortened)
