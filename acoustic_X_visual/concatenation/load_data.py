...
def load_training_data():
	...
	X_vis = np.load('CLNF_training_set_combined_features.npy')
	X_speech = np.load('speech_training_set_combined_features.npy')

	X = np.hstack((X_vis, X_speech))
...
def load_development_data():
	...
	X_vis = np.load('CLNF_development_set_combined_features.npy')
	X_speech = np.load('speech_development_set_combined_features.npy')
