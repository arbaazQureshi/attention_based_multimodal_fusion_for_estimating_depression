...
def load_training_data():
	...
	COVAREP_X_FORMANT = np.load('training_tensor_fusion_output/COVAREP_X_FORMANT_training.npy')
	facial_X_pose = np.load('training_tensor_fusion_output/facial_X_pose_training.npy')
	gaze_X_action = np.load('training_tensor_fusion_output/gaze_X_action_training.npy')
	transcript = np.load('training_tensor_fusion_output/transcript_training.npy')
	...
	return (COVAREP_X_FORMANT, facial_X_pose, gaze_X_action, transcript, Y, X_gender)
...
def load_development_data():
	...
	COVAREP_X_FORMANT = np.load('development_tensor_fusion_output/COVAREP_X_FORMANT_development.npy')
	facial_X_pose = np.load('development_tensor_fusion_output/facial_X_pose_development.npy')
	gaze_X_action = np.load('development_tensor_fusion_output/gaze_X_action_development.npy')
	transcript = np.load('development_tensor_fusion_output/transcript_development.npy')
