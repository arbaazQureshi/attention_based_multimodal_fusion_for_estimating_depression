...
if __name__ == "__main__":
	...
	model.load_weights('optimal_weights.h5', by_name = True)

	dev_Y_hat = model.predict([dev_COVAREP_X_FORMANT, dev_facial_X_pose, dev_gaze_X_action, dev_transcript, dev_X_gender])
	print(model.evaluate([dev_COVAREP_X_FORMANT, dev_facial_X_pose, dev_gaze_X_action, dev_transcript, dev_X_gender], dev_X_gender))
