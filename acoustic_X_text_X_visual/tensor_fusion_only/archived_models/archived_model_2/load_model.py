...
def load_model(location=None):
	...
	Y = Lambda(lambda x: 0.25*COVAREP_X_FORMANT_shortened + 0.25*facial_X_pose_shortened + 0.25*gaze_X_action_shortened + 0.25*transcript_elongated)(COVAREP_X_FORMANT_shortened)
	print(Y.shape)
