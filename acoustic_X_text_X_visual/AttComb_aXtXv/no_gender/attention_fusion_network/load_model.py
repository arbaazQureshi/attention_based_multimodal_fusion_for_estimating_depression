...
def load_model(location=None):
	...
	Y = Dense(310, activation = 'relu')(F)		#, kernel_regularizer = regularizers.l2(0.01)
	...
	model = Model(inputs = [COVAREP_X_FORMANT, facial_X_pose, gaze_X_action, transcript], outputs = Y)
