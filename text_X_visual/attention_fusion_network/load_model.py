...
def load_model(location=None):
	...
	B = Concatenate(axis = 1)([facial_X_pose_shortened, gaze_X_action_shortened, transcript_elongated])
	...
	F = Lambda(lambda x : alpha[:,0:1]*facial_X_pose_shortened + alpha[:,1:2]*gaze_X_action_shortened + alpha[:,2:3]*transcript_elongated)(alpha)
